...
# Ficha de evento + historial de clasificaciones de las entidades excluidas
# de la proyeccion por intervencion/disolucion SBS (ver
# motor/datos/export_entidades_excluidas.py). Organizado por tipo de
# entidad: EXCLUIDAS_DIR/<TIPO>/{historial_clasificaciones|ficha_evento}_<TIPO>.xlsx
EXCLUIDAS_DIR = os.path.join(ANALISIS_DIR, "entidades_excluidas")
...
for d in (OUTPUT_DIR, INTERFAZ_DIR, ANALISIS_DIR, ARTIFACTS_DIR, AUDIT_DIR, PRED_DIR, REPORT_DIR, FIG_DIR, DATASET_VARIABLES_DIR, EXCLUIDAS_DIR):
